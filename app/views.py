...
from . import login_manager# views.py
from flask import Blueprint, render_template, request, redirect, url_for
from .models import db, Post, Comment, Tag, User
from . import login_manager ,supabase # 假设 login_manager 在 __init__.py 中初始化
...
# from .models import db, Post, Comment, Tag, User
# from . import login_manager, supabase  # 假设 supabase 在 __init__.py 中初始化
# from flask_login import login_user, login_required, current_user, logout_user
# from datetime import datetime
# import pytz
